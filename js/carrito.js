...
function createProductCard(product) {
    ...
    inputQuantityName.innerHTML = "Cantidad: ";
...
function showCart(){
    ...
    cart.forEach( package => {
        ...
        cartPrice.innerHTML = "Precio $" + package.product.price;

        let cartQuantity = document.createElement('div');
        cartQuantity.innerHTML = "Cantidad: " + package.quantity;
    ...
    if(cart.length != 0){
        ...
        totalPriceDiv.innerText = "Precio Final: $" + totalPrice;
